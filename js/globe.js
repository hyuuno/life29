...
class Globe {
    ...
    createCityMarker(city) {
        ...
        const marker = new THREE.Mesh(
            new THREE.CircleGeometry(this.config.markerSize, 16),
        ...
        const ring = new THREE.Mesh(
            new THREE.RingGeometry(this.config.markerSize * 1.3, this.config.markerSize * 1.6, 32),
        ...
        this.markers.push({ mesh: marker, ring, city, pulsePhase: Math.random() * Math.PI * 2 });
    }
